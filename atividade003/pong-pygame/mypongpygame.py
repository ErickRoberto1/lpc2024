...
while game_loop:
    ...
    if score_1 < SCORE_MAX and score_2 < SCORE_MAX:
        ...
        if ball_x < 100:
            if player_1_y < ball_y + 20:
                if player_1_y + 150 > ball_y:
                    if player_1_y + 50 <= ball_y + 20 <= player_1_y + 100:
                        ball_dx *= -1.2
                    else:
                        if ball_y + 20 < player_1_y + 50:
                            ball_y -= 5
                        if ball_y > player_1_y + 100:
                            ball_y += 5
                        ball_dx *= -1
                    bounce_sound_effect.play()
        ...
        if ball_dx > 0 and ball_x > 600:
            if player_2_y < ball_y + 20 < player_2_y + 150:
                player_2_y += 0
            else:
                if ball_y + 20 <= player_2_y:
                    player_2_y -= 4.5
